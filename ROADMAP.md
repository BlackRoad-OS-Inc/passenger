...
- Deploy passenger to Cecilia/Octavia/Lucidia with systemd auto-start
...
- Add NLP intent routing: 'ask AI' / 'generate' / 'infer'
- Create Passenger Agent persona with RoundTrip auto-chat
- Integrate with RoadMem for persistent state across restarts
- Add Codex solution entries for common passenger operations
- Build blackroad-operator CLI commands: `br passenger status|deploy|logs`
...
- Contribute BlackRoad improvements back to upstream Ollama
